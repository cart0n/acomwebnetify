...
function requestTariff() {
    ...
    console.log(data)
    fetch("https://aacomy.herokuapp.com/t", {  
      method: 'post',  
      headers: {  
...
function Tariff() {
    ...
    async function getTariff() {
        ...
        $.ajax({
            url:'https://aacomy.herokuapp.com/z',
            async: false,
            type: 'GET',
        ...
        <div class="container tariffs">
            ...
            <article class="main-tariffs">
                ...
                <div className='tafiff-rows'>
                    ...
                    <label for="accordion-2" class="accordion-item-trigger">Гусятин</label>
                    <div className="accordion-item-content">
                    <div className="tariff-boxes">
                ...
                <div class="tariff-order">
                    <h2 class="main-tariffs-title"><a name="Оформити тариф">Оформити тариф</a></h2>
        ...
        <div className="main-footer" id="main-footer">
            ...
            <div className="footer-section">
                ...
                <div className="footer-nav">
                    ...
                    <p className="districts-footer">Гусятин</p>

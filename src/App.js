      ...
      <noscript>You need to enable JavaScript to run this app.</noscript>
        <header class="container">
          ...
          <div class="top-header">
              ...
              <div class="login">
                  <button href="" class="login-nav" id="call" onClick={toggle}><i class="fas fa-phone-alt"></i>  Передзвоніть мені</button>
                  <Modal
                    isShowing={isShowing}
                    hide={toggle}
                  />
                  <div class="hamburger-menu login-icon">
                      ...
                      <ul class="menu__box">
                        ...
                        <li><button onClick={toggle} class="menu__item"><i class="fas fa-phone-alt"></i>  Передзвоніть мені</button></li>
                      </ul>
                    </div>
              </div>
          </div>
